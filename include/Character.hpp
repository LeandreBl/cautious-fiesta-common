...
class Character
{
	...
	Character(const std::string &name, const struct stats &stats, const sf::Color &color) noexcept
	    : _name(name), _stats(stats), _hatColor(color) {};
